...
| TC-006 | Open Products page after login | User is logged in | 1. Go to https://www.saucedemo.com/inventory.html <br> 2. Log in with valid credentials |  standard_user / secret_sauce | Products page is displayed | 
| TC-007 | Display product list | User is on Products page | 1. Go to https://www.saucedemo.com/inventory.html <br> 2. Observe product list | standard_user / secret_sauce | All products are displayed with name, price and image |
