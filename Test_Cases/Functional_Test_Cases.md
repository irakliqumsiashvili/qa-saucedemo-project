...
| TC-004 | Login with empty username | User is on login page | 1. Go to https://www.saucedemo.com/ <br> 2. Leave username bar empty <br> 3. Enter valin password <br> 4. Press Login button | EMPTY FIELD/ secret_sauce | User recieves "Username is required" message |
